...
class Paginator
{
    ...
    public function __construct($total, $mid_range, $ipp_array, $paged, $curpage)
    {
        $this->return = [];
        ...
        if ($this->num_pages > 10) {
            ...
            for ($i = 1; $i <= $this->num_pages; $i++) {
                ...
                if ($i == 1 or $i == $this->num_pages or in_array($i, $this->range)) {
                    $this->return[] = ($i == $this->current_page and $this->items_per_page != 'All') ? '<li class="disabled"><a href="#">'.$i.'</a></li> ' : '<li><a title="Go to page '.$i.' of '.$this->num_pages.'" href="'.$curpage.'/page/'.$i.'">'.$i.'</a></li> ';
                }
